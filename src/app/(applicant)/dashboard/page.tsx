    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          {activePeriod ? (
            (() => {
              const days = Math.ceil((activePeriod.endDate.getTime() - Date.now()) / 86_400_000)
                ...
                <div className="bg-white rounded-2xl border border-black/[0.06] shadow-[0_1px_3px_rgba(0,0,0,0.04)] overflow-hidden">
                  ...
                  <div className="px-5 pb-5 space-y-3">
                    ...
                    <div className="flex items-center gap-1.5 text-[12px] text-[#6e6e73]">
                      ...
                      Bitiş: {fmtShort(activePeriod.endDate)}
                    </div>

                    {/* Progress bar */}
                    {(() => {
                      const totalDays = Math.ceil((activePeriod.endDate.getTime() - activePeriod.startDate.getTime()) / 86_400_000)
