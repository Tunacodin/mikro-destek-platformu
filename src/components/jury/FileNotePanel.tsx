          ...
          {canEvaluate && (
            <div className="space-y-1.5">
              ...
              <button
                ...
                className="text-[12px] font-semibold px-3 py-1.5 bg-[#212121] text-white rounded-lg hover:opacity-80 disabled:opacity-40 disabled:cursor-not-allowed transition-opacity"
              >
