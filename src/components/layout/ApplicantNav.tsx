...
import { LayoutDashboard, FilePlus, FileText, FolderOpen, LogOut, X } from "lucide-react"
...
const links = [
  ...
  { href: "/dashboard/projects",     label: "Projelerim",     icon: FolderOpen,      exact: false },
]

export function ApplicantNav({ onClose }: { onClose?: () => void }) {
